...
episode_length = 2 # How many turns to play
...
training_games = 1000 # How long to train in seconds per agent
turns = 20
games = 1000 # How many episodes to play during the testing phase
...
def train_player(blind_player, training_games: int, turns: int):
   ...
   for player in defined_players[1:2]:
      player_2 = player
